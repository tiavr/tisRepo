...
public class Grapher extends JPanel {
	...
	static final BasicStroke dash = new BasicStroke(1, BasicStroke.CAP_ROUND,
	                                                   ...
	                                                   new float[] { 4.f, 4.f },
	                                                   0.f);
        static final BasicStroke gras = new BasicStroke(4, BasicStroke.CAP_ROUND,
	                                                   BasicStroke.JOIN_ROUND,
	                                                   1.f,
	                                                   new float[] { 4.f, 4.f },
	                                                   0.f);
	...
	public void addElement(Function function) {
		functions.addElement(function);
                list.setModel(functions);
		repaint();
	}
	
//        public void listLIstener (int v){
//            list.isSelectedIndex(v);
//        }
//        
